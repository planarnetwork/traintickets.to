...
export class Fares extends React.Component<FaresProps, FaresState> {
  ...
  public componentDidMount() {
    this.props.faresEmitter.addListener("results", this.onResults);
  }

  public componentWillUnmount() {
    this.props.faresEmitter.removeListener("results", this.onResults);
  }

  public onResults = (fares: Fare[]) => {
    this.setState({ fares });
  };
